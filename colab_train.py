...
if __name__ == "__main__":
    ...
    hparams.validation_files = "filelists/ljs_audio_text_val_filelist.txt"
    ...
    hparams.batch_size = 7
    hparams.load_mel_from_disk = True
    hparams.ignore_layers = []
    hparams.epochs = 10000
    torch.backends.cudnn.enabled = hparams.cudnn_enabled
    torch.backends.cudnn.benchmark = hparams.cudnn_benchmark
    output_directory = 'C:\\Users\\bhagy\\OneDrive\\Documents\\MIR\\tacotron\\output' # Location to save Checkpoints
    log_directory = 'C:\\Users\\bhagy\\OneDrive\\Documents\\MIR\\tacotron\\logs' # Location to save Log files locally
    log_directory2 = 'C:\\Users\\bhagy\\OneDrive\\Documents\\MIR\\tacotron\\logs2' # Location to copy log files (done at the end of each epoch to cut down on I/O)
